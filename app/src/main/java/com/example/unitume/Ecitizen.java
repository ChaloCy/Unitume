...
public class Ecitizen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText your_location    = (EditText) findViewById(R.id.your_location);
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String location    = your_location.getText().toString();
                ...
                if (TextUtils.isEmpty(subject)){
                    your_location.setError("Enter Your Location");
