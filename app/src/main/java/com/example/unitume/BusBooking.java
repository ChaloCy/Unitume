...
public class BusBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText your_datetime = (EditText) findViewById(R.id.your_datetime);
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String datetime   = your_datetime.getText().toString();
                ...
                if (TextUtils.isEmpty(datetime)){
                    your_subject.setError("Enter Your Datetime");
