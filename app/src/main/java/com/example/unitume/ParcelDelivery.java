...
public class ParcelDelivery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText your_pickup = (EditText) findViewById(R.id.your_pickup);
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String pickup    = your_pickup.getText().toString();
                ...
                if (TextUtils.isEmpty(pickup)){
                    your_pickup.setError("Enter Your Pickup Location");
                    your_pickup.requestFocus();
                    return;
                }
