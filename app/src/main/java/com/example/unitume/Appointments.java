...
public class Appointments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText your_destination = (EditText) findViewById(R.id.your_destination);
        final EditText your_place = (EditText) findViewById(R.id.your_place);
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String destination  = your_destination.getText().toString();
                String place    = your_place.getText().toString();
                ...
                if (TextUtils.isEmpty(destination)){
                    your_destination.setError("Enter Your Destination");
                    your_destination.requestFocus();
                    return;
                }

                if (TextUtils.isEmpty(place)){
                    your_place.setError("Enter Place of Appointment");
                    your_place.requestFocus();
                    return;
                }
